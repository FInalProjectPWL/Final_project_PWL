			...
			<div class="box">
				...
				<form action="" method="post">
					<table id="example1" class="table table-striped table-bordered">
						<tr>
							<td>ID</td>
							<td><input name="id" type="text" value="<?php echo $record['id_datakelas']?>"></td>
						</tr>
						<tr>
							<td>Kelas</td>
...
'".$_POST['kelas']."', `jurusan` = '".$_POST['jurusan']."', `jml_siswa` = '".$_POST['jml_siswa']."' WHERE
`tb_datakelas`.`id_datakelas` ='".$_POST['id']."';";

...
$query = mysqli_query($connection,"SELECT * FROM tb_datasiswa ORDER BY id_datasiswa DESC");
?>
...
<?php 
      if (isset($_POST['submit'])) {
        ...
        $con=mysqli_query($connection, "INSERT INTO tb_datasiswa (no_rek, id_siswa, kelas, id_orgtua,saldo) VALUES ('$_POST[no_rek]','$_POST[id_siswa]','$_POST[kelas]','$_POST[id_orgtua]','$_POST[saldo]')");
